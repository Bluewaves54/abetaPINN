...
C1 = dde.Variable(10.0)
# C2 = dde.Variable(28.0)
# C3 = dde.Variable(8/3)
...
variable = dde.callbacks.VariableValue([C1,
                                        # C2, C3
                                        ], period=100, filename=fnamevar)

model.train(iterations=30000, callbacks=[variable])
