...
num_rows = 1150
time_steps = {
    "log": np.exp(np.linspace(0, np.log(1001), 1200))-1,
    "linear": np.linspace(0, 1000, 1200),
    "pcwise": np.concatenate([np.linspace(0, 5, 600), np.linspace(5, 1000, 600)]),
    "loglog": np.exp(np.exp(np.linspace(0, np.log(np.log(1001)), 1200))-1)-1,
    "sqrt": np.square(np.linspace(0, np.sqrt(1000), 1200))
}
